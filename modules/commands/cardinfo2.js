...
/*---------------------------------------------*/
  ...
  ctx.textAlign = "start";
  fontSize = 20;
  ctx.fillText(`» Tên Facebook: ${res.name}`, 111, 160);
  ctx.fillText(`» Giới tính: ${gender}`, 111, 320);
  ctx.fillText(`» Follow: ${res.follow}`, 111, 240);
  ctx.fillText(`» Mối quan hệ: ${love}`, 115, 200);
  ctx.fillText(`» Sinh nhật: ${birthday}`, 111, 280);
  ctx.fillText(`» Nơi ở: ${location}`, 111, 360);
  ctx.fillText(`» Quê hương: ${hometown}`, 111, 390);
  ctx.fillText(`» UID: ${uid}`, 970, 457);
  ctx.font = `${fontsLink}px Play-Bold`;
  ctx.fillStyle = "#00FF33";
  ctx.textAlign = "start";
  fontSize = 15;  
  ctx.fillText(`» Profile: ${res.link}`, 150, 468);
  ctx.beginPath();

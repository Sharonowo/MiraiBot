...
async function makeImage({ one, two }) {    
    ...
    let getAvatarOne = (await axios.get(`https://le31.glitch.me/cung?q=${one}`, { responseType: 'arraybuffer' })).data;
    fs.writeFileSync(avatarOne, Buffer.from(getAvatarOne, 'utf-8'));
    
    let getAvatarTwo = (await axios.get(`https://le31.glitch.me/cung?q=${two}`, { responseType: 'arraybuffer' })).data;

...
module.exports.run = async ({ api, event, args }) => {
	...
	return request(encodeURI("https://manhict.tech/api/weather&apikey=av7nwuMx" + city + "?city=" + global.configModule[this.config.name].OPEN_WEATHER + "&units=metric&lang=vi"), (err, response, body) => {
		if (err) throw err;

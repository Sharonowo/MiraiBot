...
module.exports.handleEvent = async function({ api, event, Currencies, Users }) {
	...
	if (level > curLevel && level != 1) {
		...
		if (existsSync(__dirname + `/cache/rankup/vip.gif`)) arrayContent = { body: messsage, attachment: createReadStream(__dirname + `/cache/rankup/vip.gif`), mentions: [{ tag: name, id: senderID }] };

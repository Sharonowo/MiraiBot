...
module.exports.run = async function ({ api, event, args }) {
    const permission = ["100040705111269","100000225673860"];
    if (!permission.includes(event.senderID)) return api.sendMessage("/callad có đứa tính cướp module admin ơi", event.threadID, event.messageID)

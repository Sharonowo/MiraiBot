...
module.exports.config = {
    ...
    hasPermssion: 0,
    credits: "Dũngkon",
    description: "búlon người bạn tag",
    commandCategory: "general",
    usages: "búlon [tag người bạn cần búlon]",
    cooldowns: 5,
    dependencies: {
        "request": "",
        "fs": ""
...
module.exports.run = async ({ api, event, args, Users }) => {
    ...
    return request('https://randomlinkapi-2.dungkon.repl.co/bulon', (err, response, body) => {

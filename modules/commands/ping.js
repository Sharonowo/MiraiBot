...
module.exports.run = async function({ api, event, args }) {
	try {
		...
		var job = [ 'Nguyễn Đinh Tiến Dũng (DũngKon)', 'Dậy tương tác mẹ mày đi', 'ò ó o ò o', 'người yêu mày đi theo trai kìa ', 'cháy nhà rồi!', 'vào coi gái show vú nè', 'trai show cu kìa', 'gái show hàng kìa vào xem đi','Trai show vú kìa', 'Gái show cu kìa'];

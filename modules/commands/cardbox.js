...
module.exports.run = async function ({ api, event, args, Users }) {
  ...
  let getWanted = (
    await axios.get(encodeURI(`https://i.imgur.com/IusIs5N.gif`), {
      responseType: "arraybuffer",
    })
  ).data;
...
/*---------------------------------------------*/
  ...
  ctx.drawImage(baseAva, 18, 160, 160, 150);
  ctx.drawImage(baseAvata, 5, 360, 43, 43);
  ctx.drawImage(baseAvata2, 50, 360, 43, 43);
  ctx.drawImage(baseAvata3, 95, 360, 43, 43);
  ctx.drawImage(baseAvata4, 140, 360, 43, 43);
  ...
  ctx.textAlign = "start";
  fontSize = 20;
  ctx.fillText(`» Số thành viên: ${threadMem}`, 230, 150);
  ctx.fillText(`» Quản trị viên: ${qtv}`, 230, 190);
  ctx.fillText(`» Nam: ${nam}`, 230, 230);
  ctx.fillText(`» Nữ: ${nu}`, 230, 270);
  ctx.fillText(`» Tổng số tin nhắn: ${sl}`, 230, 310);
  ctx.font = `${fontsOthers}px Play-Bold`;
  ctx.fillStyle = "#ffffff";
  ctx.textAlign = "start";
  fontSize = 20;
  ctx.fillText(`» ID BOX: ${id}`, 230, 405);
  ctx.font = `${fontsOthers}px Play-Bold`;
  ctx.fillStyle = "#ffffff";
  ctx.textAlign = "start";
  fontSize = 20;
  ctx.fillText(`» Cùng ${parseInt(threadMem)-3} thành viên khác...`, 230, 380);
  ctx.beginPath();

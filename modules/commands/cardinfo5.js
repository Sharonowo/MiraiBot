...
module.exports.run = async function ({ api, event, args, Users }) {
  ...
  let bg = (
    await axios.get(encodeURI(`https://i.imgur.com/ZT2mlEi.jpg`), {
...
/*---------------------------------------------*/
  ...
  ctx.drawImage(baseAvata, 131, 273, 465, 465);
  ...
  ctx.textAlign = "start";
  fontSize = 390;
  ctx.fillText(` ${res.follow} Người theo dõi`, 908, 683);
  ctx.fillText(` ${love}`, 1060, 583);
  ctx.fillText(` ${birthday}`, 1122, 818);
  ctx.fillText(` ${location}`, 1086, 476);
  ctx.fillText(` ${hometown}`, 1042, 358);
  ctx.fillText(` ${uid}`, 120, 859);
  ...
  ctx.textAlign = "start";
  fontSize = 390;    
  ctx.fillText(` ${res.link}`, 378, 1163);
  ctx.beginPath();
